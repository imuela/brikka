 ...
 * Sprint 19 (ADR-PROCESS-007): never attaches the internal token to /api/v1/portal/** — that
 * surface is handled exclusively by portalAuthInterceptor with its own token, mirroring the
 * backend's two independent SecurityFilterChains (ADR-PORTAL-AUTH-001). */
